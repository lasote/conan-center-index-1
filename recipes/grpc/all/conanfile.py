...
class grpcConan(ConanFile):
    ...
    def configure(self):
        if self.settings.os == "Windows" and self.settings.compiler == "Visual Studio":
            ...
            if compiler_version < 14:
                raise ConanInvalidConfiguration("gRPC can only be built with Visual Studio "
                                                "2015 or higher.")
    ...
    def source(self):
        ...
        tools.replace_in_file(os.path.join(self._source_subfolder, "cmake", "cares.cmake"),
                              "c-ares::cares",
                              "c-ares::c-ares")
    ...
    def _configure_cmake(self):
        ...
        #   non_cpp_plugins=False # Enables plugins such as --java-out and --py-out
        #   (if False, only --cpp-out is possible)
        #
        # cmake.definitions['CONAN_ADDITIONAL_PLUGINS'] = "ON" if self.options.build_csharp_ext
        # else "OFF"
        #
        # Doesn't work yet for the same reason as above
        #
        # cmake.definitions['CONAN_ENABLE_MOBILE'] = "ON" if self.options.build_csharp_ext
        # else "OFF"
        ...
        cmake.definitions["CMAKE_VERBOSE_MAKEFILE"] = 1
